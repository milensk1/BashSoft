...
namespace Executor.Repository
{
    public class StudentsRepository : IDatabase
    {
        ...
        {
            if (!(this.IsQueryForCoursePossible(courseName) && this.Courses[courseName].GetStudentByName.ContainsKey(studentUserName)))
            {
        ...
        {
            SimpleSortedList<Course> sortedCourses = new SimpleSortedList<Course>(cmp);
